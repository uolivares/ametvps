<%@ Page Title="Inicio" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="A.Register" %>
        ...
        <WizardSteps>
            <asp:CreateUserWizardStep ID="RegisterUserWizardStep" runat="server">
                <ContentTemplate>
                    ...
                    <p>Use el formulario siguiente para crear una cuenta nueva.</p>
                    <p>Las contraseñas deben tener una longitud mínima de <%= Membership.MinRequiredPasswordLength %> caracteres.</p>
                    <hr style="border-color:#CCC;"/>
                    ...
                    <div class="accountInfo">
                        <fieldset class="register">
                            ...
                            <p>
                                <asp:Label ID="DocumentoLabel" runat="server" AssociatedControlID="Documento">DNI:</asp:Label>
                                <asp:TextBox ID="Documento" Font-Names="Documento" runat="server" CssClass="textEntry form-control" ></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="Documento" 
                                     CssClass="failureNotification" ErrorMessage="El DNI de usuario es obligatorio." ToolTip="El DNI de usuario es obligatorio." 
                                     ValidationGroup="RegisterUserValidationGroup">*</asp:RequiredFieldValidator>
                            </p>
                            <p>
                                <asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="UserName">Nombre de usuario:</asp:Label>
                                <asp:TextBox ID="UserName" name="UserName"  runat="server" CssClass="textEntry form-control" ></asp:TextBox>
                        ...
                        <p class="submitButton">
                            <asp:Button ID="CreateUserButton" runat="server" CommandName="MoveNext" Text="Crear usuario" ValidationGroup="RegisterUserValidationGroup" class="btn btn-success"/>
                        </p>
                    </div>
                </ContentTemplate>
