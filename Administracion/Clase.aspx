<%@ Page Title="Clases" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Clase.aspx.cs" Inherits="A.Clase" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <asp:Label ID="IdClaseT" runat="server" Visible="false"></asp:Label>
...
<table id="t_grilla" runat="server"  width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
           <tr>
            <td> 
                  <table id="Table2" runat="server" width="100%" border="0" align="center" >
                    <tr> 
                        ...
                        <asp:Button ID="Button3" runat="server" Text=">> Nueva Clase" OnClick="f_agregar_nuevo" class="btn btn-success"/></td>
                    </tr>    
                   </table>
                <br />
             </td>
            ...
            <td align="center">
                ...
                <asp:TemplateField HeaderText="Código Clase">
                <ItemTemplate>
                <asp:Label id="CodClase" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "CodClase")%>'></asp:Label>	
                </ItemTemplate>  
                </asp:TemplateField>
     ...
     <table id="t_form" align="center" runat="server" border="0" cellpadding="0" cellspacing="0" width="90%">
            <tr style="height: 30px;">
                <td align="right">Código Clase:&nbsp;</td>
                <td><asp:TextBox ID="CodClase" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator id="RequiredFieldValidator2" ControlToValidate="CodClase"  ErrorMessage="* Obligatorio" runat="server"/></td>
