<%@ Page Title="Inicio" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Sector.aspx.cs" Inherits="A.Sector" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <h2><span class="glyphicon glyphicon-share-alt" style="font-size: 27px; color:tomato"></span> <span class="glyphicon glyphicon-equalizer" style="font-size: 27px; color:tomato"></span>&nbsp;&nbsp;<asp:Label ID="Titulo" runat="server"></asp:Label></h2>
    <hr style="border-color:#CCC;"/>
    <asp:Label ID="mensaje" runat="server" ForeColor="#0000ff"></asp:Label>
    <asp:Label ID="IdSectorT" runat="server" Visible="false"></asp:Label>
...
<table id="t_grilla" runat="server"  width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
           <tr>
            <td> 
                  <table id="Table2" runat="server" width="100%" border="0" align="center" >
                    <tr> 
                        ...
                        <asp:Button ID="Button3" runat="server" Text=">> Nuevo Sector" OnClick="f_agregar_nuevo" class="btn btn-success"/></td>
                    </tr>    
                   </table>
                <br />
             </td>
            ...
            <td align="center">
                ...
                <asp:TemplateField HeaderText="Código Sector">
                <ItemTemplate>
                <asp:Label id="CodSector" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "CodSector")%>'></asp:Label>	
                </ItemTemplate>  
                </asp:TemplateField>
     ...
     <table id="t_form" align="center" runat="server" border="0" cellpadding="0" cellspacing="0" width="90%">
            <tr style="height: 30px;">
                <td align="right">Código Sector:&nbsp;</td>
                <td><asp:TextBox ID="CodSector" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator id="RequiredFieldValidator2" ControlToValidate="CodSector"  ErrorMessage="* Obligatorio" runat="server"/></td>
                <td align="right">Descripción:&nbsp;</td>
                <td align="left"><asp:TextBox ID="Descripcion" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator id="RequiredFieldValidator3" ControlToValidate="Descripcion"  ErrorMessage="* Obligatorio" runat="server"/>
                </td>
            </tr>
            <tr><td colspan="4">&nbsp;</td>
            </tr>
